...
TAGMES = [ " **𝐣𝐮𝐢𝐜𝐞 𝐩𝐢𝐥𝐚 𝐝𝐨 𝐦𝐨𝐬𝐚𝐦𝐢 𝐤𝐚🤕𝐣𝐮𝐢𝐜𝐞 𝐩𝐢𝐥𝐚 𝐝𝐨🥲𝐦𝐞𝐫𝐚 𝐦𝐨𝐨𝐝 𝐨𝐟𝐟 𝐡𝐚𝐢🥺𝐣𝐮𝐢𝐜𝐞 𝐩𝐢𝐥𝐚 𝐝𝐨🤣😂𝐦𝐨𝐬𝐚𝐦𝐢 𝐤𝐚🤕** ",
           " **𝐂𝐡𝐢𝐧 𝐓𝐚𝐩𝐚𝐤 𝐝𝐡𝐮𝐦 𝐝𝐡𝐮𝐦 👻👻** ",
           " **𝐤𝐞𝐡𝐥𝐞𝐠𝐚 𝐟𝐫𝐞𝐞 𝐟𝐢𝐫𝐞 💀☠️** ",
           " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐇𝐞𝐦𝐥𝐨𝐨🧐** ",
           " **𝐌𝐮𝐣𝐡𝐞 𝐁𝐡𝐮𝐥 𝐆𝐲𝐞 𝐊𝐲𝐚🥺** ",
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @ABOUT_VIP_STRANGER ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @ABOUT_VIP_STRANGER ] 🤗** ",
           " **𝐄𝐤 𝐃𝐢𝐥 𝐇𝐚𝐢 𝐄𝐤 𝐃𝐢𝐥 𝐇𝐢 𝐓𝐨 𝐇𝐚𝐢😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @TSGCODER ]🥰** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐉𝐚𝐚𝐧😜** ",
